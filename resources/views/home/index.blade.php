...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand logo" href="#">Minton</a>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="home-wrapper text-center">
                    <h1 class="animated fadeInDown wow" data-wow-delay=".1s">Minton - Responsive Admin Dashboard</h1>
                    <p class="animated fadeInDown wow" data-wow-delay=".2s">Minton is a fully featured premium admin template built on top of awesome Bootstrap 4, modern web technology HTML5,
                        <br/> CSS3 and jQuery. It has many ready to use hand crafted components.</p>
                    <a href="" class="btn btn-primary btn-rounded w-lg animated fadeInDown wow" data-wow-delay=".4s">Buy Now</a>
                    <div class="clearfix"></div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="feature-detail">
                    ...
                    <p class="sub fadeIn animated wow" data-wow-delay=".2s">Constituto voluptatibus mei ex. Eum soleat lorem Ipsum is simply dummy
                        <br/> text of the printing and typesetting industry. </p>

                    <ul class="list-unstyled">
                        <li>
                            <i class=" ti-arrow-circle-right"></i> Aliquam a augue suscipit, bibendum luctus neque. Vestibulum laoreet rhoncus ipsum, bibendum ullamcorper hendrerit tellus.
                        </li>
                        <li>
                            <i class=" ti-arrow-circle-right"></i> We put a lot of effort in design, as it’s the most important ingredient of successful website.
                        </li>
    ...
    <div class="container">
        ...
        <div class="row text-center">
            <div class="col-md-3 col-sm-3 facts">
                ...
                <h1><span class="counter">6577</span> k</h1>
                <h4>Lines Coded</h4>
            </div>
            <!-- /facts-1 -->
            <div class="col-md-3 col-sm-3 facts">
                <i class="ti-timer"></i>
                <h1> <span class="counter">7800</span> +</h1>
                <h4>Working Hours</h4>
            </div>
            <!-- /facts-2 -->
            <div class="col-md-3 col-sm-3 facts">
                <i class="ti-briefcase"></i>
                <h1 class="counter">399</h1>
                <h4>No. Of Template</h4>
            </div>
            <!-- /facts-3 -->
            <div class="col-md-3 col-sm-3 facts">
                <i class=" ti-user"></i>
                <h1 class="counter">9995</h1>
                <h4>Clients</h4>
            </div>
            <!-- /facts-4 -->
        </div>
...
<footer class="footer bg-dark">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center">
                <p class="copyright">2017 © Minton.</p>
            </div>
        </div>
        <!-- end row -->
    </div>
